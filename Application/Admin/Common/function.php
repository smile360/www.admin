...
function getAllMenu(){
	return	array(
			...
			'consult' => array('name' => '咨询管理', 'icon'=>'fa-adjust', 'sub_menu' => array(
					array('name' => '咨询列表','act'=>'index','control'=>'Consult'),
					array('name' => '咨询评论','act'=>'comment','control'=>'Consult'),
					// array('name' => '商品咨询','act'=>'ask_list','control'=>'Consult'),
			)),
			...
			'activity' => array('name' => '课程管理', 'icon'=>'fa-bell', 'sub_menu' => array(
					array('name' => '课程添加', 'act'=>'activity', 'control'=>'Activity'),
					array('name' => '课程列表', 'act'=>'activity_list', 'control'=>'Activity'),
					array('name' => '申请列表', 'act'=>'activity_applicant_list', 'control'=>'Activity'),
					array('name' => '课程评论', 'act'=>'activity_comment', 'control'=>'Activity'),
			)),
			...
			'Ad' => array('name' => '轮播管理', 'icon'=>'fa-flag', 'sub_menu' => array(
					...
					array('name' => '轮播位置', 'act'=>'positionList', 'control'=>'Ad'),
			)),
			'content' => array('name' => '文章管理', 'icon'=>'fa-comments', 'sub_menu' => array(
					...
					array('name' => '文章评论', 'act'=>'comment', 'control'=>'Article'),
					// array('name' => '写稿权限', 'act'=>'writeRole', 'control'=>'Article'),
					// array('name' => '热词列表', 'act'=>'hotWodsList', 'control'=>'Article'),
...
function getCatName($id){
	if($id=='86'){return "文章发布";}
	if($id=='87'){return "关于我们";}
	if($id=='88'){return "快讯";}
	if($id=='89'){return "涨停板";}
	if($id=='90'){return "精华版";}
	if($id=='91'){return "实时内情";}
	if($id=='92'){return "新声Tv";}
	if($id=='93'){return "三板客";}
	if($id=='94'){return "深度";}
	if($id=='95'){return "酷公司";}
	if($id=='96'){return "CEO新声";}
	if($id=='97'){return "互联网金融";}
	if($id=='98'){return "O2O智能硬件";}
	if($id=='99'){return "创业投资";}
}