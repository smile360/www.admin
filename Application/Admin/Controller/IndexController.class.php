...
class IndexController extends BaseController {
    ...
    public function index(){
        ...
        $menu_list = getMenuList($act_list); //左侧导航栏
    ...
    public function welcome(){
    	...
    	$count['consult'] = M('consult')->where("is_show=0")->count();//最新评论
    ...
    public function changeTableVal(){  
            ...
            $value  = I('value'); // 修改字段值          
            M($table)->where("$id_name = $id_value")->setField(array($field=>$value)); // 根据条件保存修改的数据
