...
class OrderLogic extends RelationModel
{
    ...
    public function getOrderGoods($order_id){
        $sql = "SELECT g.*,o.*,(o.goods_num * o.member_goods_price) AS goods_total,s.src FROM __PREFIX__order_goods o ".
            "LEFT JOIN __PREFIX__goods g ON o.goods_id = g.goods_id LEFT JOIN tp_spec_image s ON o.goods_id = s.goods_id and o.spec_key=s.spec_image_id WHERE o.order_id = $order_id";
        $res = $this->query($sql);
        return $res;
    }
