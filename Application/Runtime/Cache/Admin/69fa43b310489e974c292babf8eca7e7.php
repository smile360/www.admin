		...
		<div class="row">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box">
                ...
                <div class="info-box-content">
                  <span class="info-box-text">咨询数量</span>
                  <span class="info-box-number"><?php echo ($count["consult"]); ?></span>
                </div>
              </div>
            </div>
            <div class="col-md-3 col-sm-6 col-xs-12">
                    ...
                    <div class="box  box-success">
				        <div class="box-body">
				        	<div class="info-box">
					         	<table class="table table-bordered">
					         		<tr>
					         			<td>程序版本：</td><td>果本科技管理系统 <?php echo ($sys_info["version"]); ?></td>
					         			<td>更新时间：</td><td>2016-05-01</td>
					         			<td>程序开发：</td><td>深圳搜豹网络有限公司</td>			         			
					         		</tr>
					         		<tr>
					         			<td>版权所有：</td><td>深圳果本科技有限公司</td>
