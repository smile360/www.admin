  ...
  <body class="login-page">
    <div class="login-box">
      ...
      <div class="login-box-body">
	    ...
	    <div class="margin text-center">
	        <div class="copyright">
	            2012-<?php echo date('Y');?> &copy; <a href="http://cjsuo.zhan.qq.com">深圳果本科技 v0.0.1</a>
	            <br/>
	            <a href="http://cjsuo.zhan.qq.com">深圳果本科技</a>出品
	        </div>
	    </div>
    </div><!-- /.login-box -->
    <!-- jQuery 2.1.4 -->
    ...
    <script>
      ...
      function fleshVerify(){
          //重载验证码
          $('#imgVerify').attr('src',"<?php echo U('Admin/vertify');?>?r="+Math.floor(Math.random()*100));
      }
      ...
      function checkLogin(){
          ...
          $.ajax({
          		url:"<?php echo U('Admin/login');?>?t="+Math.random(),
        			type:'post',
        			dataType:'json',
