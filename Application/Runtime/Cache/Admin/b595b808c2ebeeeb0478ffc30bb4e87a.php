      ...
      <nav class="navbar navbar-static-top" role="navigation">
        ...
        <div class="navbar-custom-menu">
          ...
          <?php if($upgradeMsg[0] != null): ?><li>
           ...
           <li>
               <a target="rightContent" href="<?php echo U('System/cleanCache');?>">
...
<section class="content-wrapper right-side" id="riframe" style="margin:0px;padding:0px;margin-left:230px;">
    <iframe id='rightContent' name='rightContent' src="<?php echo U('Index/welcome');?>" width='100%' frameborder="0"></iframe>
</section>
	...
	<footer class="main-footer">
	   ...
	   <strong>Copyright &copy; 2015-2025 <a href="http://cjsuo.zhan.qq.com">深圳果本科技产品</a>.</strong>保留所有权利。
	</footer>
