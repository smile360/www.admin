<?php if (!defined('THINK_PATH')) exit();?><title>枫FENGZAKKA-购物车</title>
<!DOCTYPE html>
<html>
...
<link rel="stylesheet" href="/Public/Static/css/flow.css">
<link rel="stylesheet" href="/Public/Static/css/style_jm.css">
...
<form name="cart2_form" id="cart2_form" method="post">
    ...
    <section class="order " id="order4">
      ...
      <!--
        	<h4 class="seller-name" > <img src="/Public/Static/images/flow/dingdan.png" width="28"> 
          ...
          <ul class="order-list-info">
           <?php if(is_array($cartList)): foreach($cartList as $k=>$v): if($v[selected] == '1'): ?><li class="item" >
            ...
            <label id="Bonus_span_0">
               买家留言：
                  <input id="remark" name="user_note"  type="text"   placeholder="选填项，交易备注" class="txt1" style="width:auto;"/>
                 </label>
            </li>
            <li class="flow_youhui_no" style="display:none">如果是会员<font color=red></font>，可以享受会员折扣价</li>
   ...
   <section class="order-info">
    <div class="order-list">
      <div class="content ptop0" style="display:none">
        <div class="panel panel-default info-box">
          <div class="orderInfo " >
            <h4 class="seller-name"> <img src="/Public/Static/images/flow/dingdan.png" width="28"> 其他选项 </h4>
          </div>
            ...
            <div class="panel panel-default info-box">
              <div class="con-ct fo-con">
                <ul class="ct-list order_total_ul" id="ECS_ORDERTOTAL" >
                  <li class="order_total_li" style="display:none"> 
              ...
              <div class="panel panel-default info-box">
                <div class="pay-btn" style="margin-bottom:50px">
...
function ajax_order_price()
{
    $.ajax({
        type : "POST",
        url:"<?php echo U('Cart/cart3');?>?act=order_price&t="+Math.random(),
...
function submit_order()
{
    ...
    $.ajax({
        ...
        success: function(data){
            ...
            setTimeout(function() {
              location.href = "<?php echo U('Cart/cart4');?>?order_id="+data.result;
            }, 1500)
