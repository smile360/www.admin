...
<meta name="Generator" content="TPSHOP v1.1" />
  ...
  <link rel="stylesheet" href="/Public/Static/css/loginxin.css">
...
<div class="ng-form-zhu" style="text-align: center;font-size:16px;">
  <div class="tips_a">
      ...
      <img src="/Public/Static/images/xin/icogantanhao.png"></div>
     <?php }else{ ?>
     <img src="/Public/Static/images/xin/icogantanhao-sb.png"></div>
     <?php }?>
  <div class="tips">
