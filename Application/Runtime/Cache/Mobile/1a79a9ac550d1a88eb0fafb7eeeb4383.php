           ...
           <div style="width:60%; float:left; height:98px;">
             ...
             <div class="num">
                 <div class="xm-input-number">
                   <div class="act_wrap">
                        <a href="javascript:;" onclick="switch_num(-10,<?php echo ($v["id"]); ?>,<?php echo ($v["store_count"]); ?>);" id="jiannum6" class="input-sub active"></a>
                     	...
                     	<a href="javascript:;" onclick="switch_num(10,<?php echo ($v["id"]); ?>,<?php echo ($v["store_count"]); ?>);"  class="input-add active"></a>
                     </div>
                  </div>                 
             </div>
           </div>
...
<section id="cart-content">
      ...
      <div class="qb_gap" style="width:60%; margin:0 auto;">
        <a href="<?php echo U('Goods/index');?>" class="mod_btn btn_strong">马上逛逛</a>
      </div>
</section>
